 ...
 * Description
 */
public class CornersView extends View {
    ...
    public CornersView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mPaint.setColor(Color.parseColor("#abc223"));

        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.CornersView);
        mCornerSize = (int) ta.getDimension(R.styleable.CornersView_cornerSize, 0);
        mLeftBottomCorner = (int) ta.getDimension(R.styleable.CornersView_leftBottomCorner, 0);
        mLeftTopCorner = (int) ta.getDimension(R.styleable.CornersView_leftTopCorner, 0);
        mRightBottomCorner = (int) ta.getDimension(R.styleable.CornersView_rightBottomCorner, 0);
        mRightTopCorner = (int) ta.getDimension(R.styleable.CornersView_rightTopCorner, 0);
        ta.recycle();
