...
public class MarkDownParser {
     ...
     * @param json
     */
    public void readMarkdownByJson(String json, OnMarkListener listener) {
        mListener = listener;
        mdList.clear();
        mdListType.clear();
        ...
        for (int i = 0; i < mdList.size(); i++) {
            ...
            translateToEntity(line);
        }
    }

    private String translateToEntity(String line) {
        String html = "";
