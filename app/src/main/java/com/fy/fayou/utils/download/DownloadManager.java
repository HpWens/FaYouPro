package com.fy.fayou.utils.download;
...
public class DownloadManager {
     ...
     * 下载路径
     */
    public final static String FILE_PATH = Environment.getExternalStorageDirectory().getAbsolutePath() + "/fayou/";
    ...
    public void download(String url, Observer<DownloadInfo> observer) {
        Observable.just(url)
                .filter(new Predicate<String>() { // 过滤 call的map中已经有了,就证明正在下载,则这次不下载
                    @Override
                    public boolean test(String s) {
