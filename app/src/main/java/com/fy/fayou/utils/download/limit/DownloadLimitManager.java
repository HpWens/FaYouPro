package com.fy.fayou.utils.download.limit;

import com.fy.fayou.utils.download.DownloadIO;
...
public class DownloadLimitManager {
    ...
    public void cancelDownload(DownloadInfo info) {
        ...
        EventBus.getDefault().post(info);
        RxFileTool.deleteFile(info.getFileName());
    }
    ...
    private DownloadInfo getRealFileName(DownloadInfo downloadInfo) {
        ...
        File path = new File(DownloadManager.FILE_PATH);
        if (!path.exists()) {
            path.mkdir();
        }
        File file = new File(DownloadManager.FILE_PATH, fileName);
        if (file.exists()) {
        ...
        while (downloadLength >= contentLength) {
            ...
            File newFile = new File(DownloadManager.FILE_PATH, fileNameOther);
            file = newFile;
