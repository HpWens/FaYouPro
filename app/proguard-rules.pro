...
-keep public class android.app.AppComponentFactory
-keep public class android.support.v4.app.CoreComponentFactory
-keep public class com.fy.fayou.fragment.LearnFragment
